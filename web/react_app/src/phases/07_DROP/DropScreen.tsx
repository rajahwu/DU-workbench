...
/**
 * DropScreen — presentational layout.
 * Run summary, mock unlocks/scars, loop-back button.
        ...
        <div className="drop-shell-wrapper">
            ...
            <div className="content-area">
                ...
                <div>
                    ...
                    {survived && (
                        <span className="unlock-badge" style={{ borderColor: "#D4A843", color: "#D4A843" }}>
                            Boon: Deep Memory
                        </span>
                    )}
            ...
            <div className="bottom-action">
                <button className="btn-primary" onClick={onReturnToStaging}>
                    Return to Staging
                </button>
            </div>
        </div>
